...
public class DefaultCyclingraceFacadeService implements CyclingraceFacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCyclingraceFacadeService.class);
	...
	{
		return DefaultCyclingraceFacadeService.class.getResourceAsStream("/cyclingraceFacade/sap-hybris-platform.png");
	}
