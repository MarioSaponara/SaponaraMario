...
/**
 * This is the extension manager of the CyclingraceFacade extension.
 */
public class CyclingraceFacadeManager extends GeneratedCyclingraceFacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclingraceFacadeManager.class);
	 ...
	 */
	public static CyclingraceFacadeManager getInstance()
	{
		return (CyclingraceFacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclingraceFacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclingraceFacadeManager() // NOPMD 
	{
		LOG.debug("constructor of CyclingraceFacadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclingraceFacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclingraceFacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
