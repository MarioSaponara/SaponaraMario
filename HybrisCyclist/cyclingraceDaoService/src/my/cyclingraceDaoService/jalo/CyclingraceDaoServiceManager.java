...
/**
 * This is the extension manager of the CyclingraceDaoService extension.
 */
public class CyclingraceDaoServiceManager extends GeneratedCyclingraceDaoServiceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclingraceDaoServiceManager.class);
	 ...
	 */
	public static CyclingraceDaoServiceManager getInstance()
	{
		return (CyclingraceDaoServiceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclingraceDaoServiceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclingraceDaoServiceManager() // NOPMD 
	{
		LOG.debug("constructor of CyclingraceDaoServiceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclingraceDaoServiceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclingraceDaoServiceManager called, current tenant: {}", getTenant().getTenantID());
	}
