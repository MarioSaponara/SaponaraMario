...
public class DefaultCyclingraceDaoServiceService implements CyclingraceDaoServiceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCyclingraceDaoServiceService.class);
	...
	{
		return DefaultCyclingraceDaoServiceService.class.getResourceAsStream("/cyclingraceDaoService/sap-hybris-platform.png");
	}
