...
public class DefaultCyclingracefrontService implements CyclingracefrontService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCyclingracefrontService.class);
	...
	{
		return DefaultCyclingracefrontService.class.getResourceAsStream("/cyclingracefront/sap-hybris-platform.png");
	}
