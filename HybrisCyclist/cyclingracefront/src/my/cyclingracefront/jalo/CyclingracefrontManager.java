 ...
 */
package my.cyclingracefront.jalo;
...
/**
 * This is the extension manager of the Cyclingracefront extension.
 */
public class CyclingracefrontManager extends GeneratedCyclingracefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclingracefrontManager.class);
	 ...
	 */
	public static CyclingracefrontManager getInstance()
	{
		return (CyclingracefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclingracefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclingracefrontManager() // NOPMD 
	{
		LOG.debug("constructor of CyclingracefrontManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclingracefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclingracefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
